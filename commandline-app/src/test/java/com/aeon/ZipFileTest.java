...
public class ZipFileTest {
  ...
  private void writeToImage(byte[] imageBytes) throws IOException {
    ...
    doSomethingElse(List.of("a", "B").stream().toString());
  }

  private static void doSomethingElse(String arguments) {
    System.out.println("arguments: {}".formatted(arguments));
    Arrays.stream(arguments.split(",")).forEach(it -> System.out.println(it));
  }
